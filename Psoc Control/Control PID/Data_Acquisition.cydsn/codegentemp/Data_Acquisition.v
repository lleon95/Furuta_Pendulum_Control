// ======================================================================
// Data_Acquisition.v generated from TopDesign.cysch
// 05/18/2018 at 13:46
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=2, CounterSize=16, CounterSizeReplacementString=int16, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONFIG_TITLE=QuadDec_Motor, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec_Motor, CY_INSTANCE_SHORT_NAME=QuadDec_Motor, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=QuadDec_Motor, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=1, CompareMode=0, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=32768, CONTROL3=0, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InitCounterValue=32768, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=32768, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Cnt16, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec_Sensor:Cnt16, CY_INSTANCE_SHORT_NAME=Cnt16, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=QuadDec_Sensor_Cnt16, )
...
// QuadDec_v3_0(Counter8bit=false, CounterResolution=2, CounterSize=16, CounterSizeReplacementString=int16, CounterSizeReplacementStringUnsigned=uint16, TypeCastReplacementString=int32, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONFIG_TITLE=QuadDec_Sensor, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec_Sensor, CY_INSTANCE_SHORT_NAME=QuadDec_Sensor, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=QuadDec_Sensor, )
...
module top ;
    ...
    QuadDec_v3_0_2 QuadDec_Motor (
        .quad_A(Net_49),
        .quad_B(Net_50),
        .index(1'b0),
        .clock(Net_52),
        .interrupt(Net_53));
    defparam QuadDec_Motor.CounterResolution = 2;
    defparam QuadDec_Motor.UsingGlitchFiltering = 1;
    defparam QuadDec_Motor.UsingIndexInput = 0;

	wire [0:0] tmpOE__Pin_B_S2_net;
	wire [0:0] tmpIO_0__Pin_B_S2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_B_S2_net;
	electrical [0:0] tmpSIOVREF__Pin_B_S2_net;

	cy_psoc3_pins_v1_10
		#(.id("906cefb2-42ee-4152-bccc-34c3a05e579b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_B_S2
		 (.oe(tmpOE__Pin_B_S2_net),
		  .y({1'b0}),
		  .fb({Net_41}),
		  .io({tmpIO_0__Pin_B_S2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_B_S2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_B_S2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_B_S2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_A_S2_net;
	wire [0:0] tmpIO_0__Pin_A_S2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_A_S2_net;
	electrical [0:0] tmpSIOVREF__Pin_A_S2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_A_S2
		 (.oe(tmpOE__Pin_A_S2_net),
		  .y({1'b0}),
		  .fb({Net_40}),
		  .io({tmpIO_0__Pin_A_S2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_A_S2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_A_S2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_A_S2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    QuadDec_v3_0_4 QuadDec_Sensor (
        .quad_A(Net_40),
        .quad_B(Net_41),
        .index(1'b0),
        .clock(Net_43),
        .interrupt(Net_47));
    defparam QuadDec_Sensor.CounterResolution = 2;
    defparam QuadDec_Sensor.UsingGlitchFiltering = 1;
    defparam QuadDec_Sensor.UsingIndexInput = 0;

	wire [0:0] tmpOE__Pin_A_M_net;
	wire [0:0] tmpIO_0__Pin_A_M_net;
	wire [0:0] tmpINTERRUPT_0__Pin_A_M_net;
	electrical [0:0] tmpSIOVREF__Pin_A_M_net;

	cy_psoc3_pins_v1_10
		#(.id("64859c2c-d894-4cdb-b260-c0ccf03ed1a6"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_A_M
		 (.oe(tmpOE__Pin_A_M_net),
		  .y({1'b0}),
		  .fb({Net_49}),
		  .io({tmpIO_0__Pin_A_M_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_A_M_net),
		  .interrupt({tmpINTERRUPT_0__Pin_A_M_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_A_M_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_B_M_net;
	wire [0:0] tmpIO_0__Pin_B_M_net;
	wire [0:0] tmpINTERRUPT_0__Pin_B_M_net;
	electrical [0:0] tmpSIOVREF__Pin_B_M_net;

	cy_psoc3_pins_v1_10
		#(.id("c083527d-2a70-4079-ad17-e4f688d63596"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_B_M
		 (.oe(tmpOE__Pin_B_M_net),
		  .y({1'b0}),
		  .fb({Net_50}),
		  .io({tmpIO_0__Pin_B_M_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_B_M_net),
		  .interrupt({tmpINTERRUPT_0__Pin_B_M_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_B_M_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__H_Enable_net;
	wire [0:0] tmpFB_0__H_Enable_net;
	wire [0:0] tmpIO_0__H_Enable_net;
	wire [0:0] tmpINTERRUPT_0__H_Enable_net;
	electrical [0:0] tmpSIOVREF__H_Enable_net;

	cy_psoc3_pins_v1_10
		#(.id("eed0a237-d2fc-43f5-9d8c-28b82757bb54"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		H_Enable
		 (.oe(tmpOE__H_Enable_net),
		  .y({Net_542}),
		  .fb({tmpFB_0__H_Enable_net[0:0]}),
		  .io({tmpIO_0__H_Enable_net[0:0]}),
		  .siovref(tmpSIOVREF__H_Enable_net),
		  .interrupt({tmpINTERRUPT_0__H_Enable_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__H_Enable_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__H_Dir2_net;
	wire [0:0] tmpFB_0__H_Dir2_net;
	wire [0:0] tmpIO_0__H_Dir2_net;
	wire [0:0] tmpINTERRUPT_0__H_Dir2_net;
	electrical [0:0] tmpSIOVREF__H_Dir2_net;

	cy_psoc3_pins_v1_10
		#(.id("cbb6cb74-2c8a-4356-8130-732a64b6ad32"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		H_Dir2
		 (.oe(tmpOE__H_Dir2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__H_Dir2_net[0:0]}),
		  .io({tmpIO_0__H_Dir2_net[0:0]}),
		  .siovref(tmpSIOVREF__H_Dir2_net),
		  .interrupt({tmpINTERRUPT_0__H_Dir2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__H_Dir2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__H_Dir1_net;
	wire [0:0] tmpFB_0__H_Dir1_net;
	wire [0:0] tmpIO_0__H_Dir1_net;
	wire [0:0] tmpINTERRUPT_0__H_Dir1_net;
	electrical [0:0] tmpSIOVREF__H_Dir1_net;

	cy_psoc3_pins_v1_10
		#(.id("b985fc30-1c1e-4057-b7c0-12871ddaf510"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		H_Dir1
		 (.oe(tmpOE__H_Dir1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__H_Dir1_net[0:0]}),
		  .io({tmpIO_0__H_Dir1_net[0:0]}),
		  .siovref(tmpSIOVREF__H_Dir1_net),
		  .interrupt({tmpINTERRUPT_0__H_Dir1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__H_Dir1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__START_BTN_net;
	wire [0:0] tmpFB_0__START_BTN_net;
	wire [0:0] tmpIO_0__START_BTN_net;
	wire [0:0] tmpINTERRUPT_0__START_BTN_net;
	electrical [0:0] tmpSIOVREF__START_BTN_net;

	cy_psoc3_pins_v1_10
		#(.id("6c7078f3-d2a7-41e4-b16b-16937804e389"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		START_BTN
		 (.oe(tmpOE__START_BTN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__START_BTN_net[0:0]}),
		  .io({tmpIO_0__START_BTN_net[0:0]}),
		  .siovref(tmpSIOVREF__START_BTN_net),
		  .interrupt({tmpINTERRUPT_0__START_BTN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__START_BTN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
