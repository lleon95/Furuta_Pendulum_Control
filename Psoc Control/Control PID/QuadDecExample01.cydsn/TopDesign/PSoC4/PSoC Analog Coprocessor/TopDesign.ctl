...
-- === UART ===
attribute port_location of \UART:rx(0)\ : label is "PORT(0,5)";
attribute port_location of \UART:tx(0)\ : label is "PORT(0,4)";
...
attribute port_location of phiA_In(0) : label is "PORT(4,0)";
attribute port_location of phiA_Out(0) : label is "PORT(2,0)";
attribute port_location of phiB_In(0) : label is "PORT(4,1)";