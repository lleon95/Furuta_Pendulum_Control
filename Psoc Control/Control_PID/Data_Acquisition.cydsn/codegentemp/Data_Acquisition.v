...
module top ;
	...
	wire [0:0] tmpOE__Pin_A_S1_net;
	wire [0:0] tmpIO_0__Pin_A_S1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_A_S1_net;
	electrical [0:0] tmpSIOVREF__Pin_A_S1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("64859c2c-d894-4cdb-b260-c0ccf03ed1a6"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_A_S1
		 (.oe(tmpOE__Pin_A_S1_net),
		  .y({1'b0}),
		  .fb({Net_49}),
		  .io({tmpIO_0__Pin_A_S1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_A_S1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_A_S1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_A_S1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_B_S1_net;
	wire [0:0] tmpIO_0__Pin_B_S1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_B_S1_net;
	electrical [0:0] tmpSIOVREF__Pin_B_S1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c083527d-2a70-4079-ad17-e4f688d63596"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_B_S1
		 (.oe(tmpOE__Pin_B_S1_net),
		  .y({1'b0}),
		  .fb({Net_50}),
		  .io({tmpIO_0__Pin_B_S1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_B_S1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_B_S1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_B_S1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
