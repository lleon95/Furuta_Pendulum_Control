// ======================================================================
// QDExample01.v generated from TopDesign.cysch
// 03/19/2018 at 13:26
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("79ed2464-4238-4768-9c7b-4558066b0839/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("17dbeb50-56d1-4ab6-8558-d5a66e394af4"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("febea000-1bdd-4ef1-a990-3a44afd8877b"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
    ...
    QuadDec_v3_0_4 QD (
        ...
        .clock(Net_138),
        .interrupt(Net_145));
    defparam QD.CounterResolution = 1;
    defparam QD.UsingGlitchFiltering = 1;
    defparam QD.UsingIndexInput = 1;

    CyControlReg_v1_80 Control_Reg_Index (
        .control_1(Net_453),
        .control_2(Net_454),
        .control_3(Net_455),
        .control_0(Net_425),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Control_Reg_Index.Bit0Mode = 0;
    defparam Control_Reg_Index.Bit1Mode = 0;
    defparam Control_Reg_Index.Bit2Mode = 0;
    defparam Control_Reg_Index.Bit3Mode = 0;
    defparam Control_Reg_Index.Bit4Mode = 0;
    defparam Control_Reg_Index.Bit5Mode = 0;
    defparam Control_Reg_Index.Bit6Mode = 0;
    defparam Control_Reg_Index.Bit7Mode = 0;
    defparam Control_Reg_Index.BitValue = 0;
    defparam Control_Reg_Index.BusDisplay = 0;
    defparam Control_Reg_Index.ExtrReset = 0;
    defparam Control_Reg_Index.NumOutputs = 1;

    // -- Mux start --
    if (1)
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_462 or Net_401 or Net_425)
        begin
            case (Net_425)
                1'b0 :  tmp__mux_1_reg = Net_462;
                1'b1 :  tmp__mux_1_reg = Net_401;
            endcase
        end
        assign Net_403 = tmp__mux_1_reg;
    end
    // -- Mux end --
    ...
    begin : mux_2
        reg  tmp__mux_2_reg;
        always @(Net_463 or Net_406 or Net_425)
        begin
            case (Net_425)
                1'b0 :  tmp__mux_2_reg = Net_463;
                1'b1 :  tmp__mux_2_reg = Net_406;
            endcase
        end
        assign Net_409 = tmp__mux_2_reg;
    end
    // -- Mux end --
	...
	wire [3:0] tmpOE__Pin_outs_net;
	wire [3:0] tmpFB_3__Pin_outs_net;
	wire [3:0] tmpIO_3__Pin_outs_net;
	wire [0:0] tmpINTERRUPT_0__Pin_outs_net;
	electrical [0:0] tmpSIOVREF__Pin_outs_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_outs
		 (.oe(tmpOE__Pin_outs_net),
		  .y({Net_138, Net_425, Net_409, Net_403}),
		  .fb({tmpFB_3__Pin_outs_net[3:0]}),
		  .io({tmpIO_3__Pin_outs_net[3:0]}),
		  .siovref(tmpSIOVREF__Pin_outs_net),
		  .interrupt({tmpINTERRUPT_0__Pin_outs_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_outs_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
