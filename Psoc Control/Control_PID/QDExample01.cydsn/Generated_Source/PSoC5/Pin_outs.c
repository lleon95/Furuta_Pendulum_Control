...
*
* \funcusage
*  \snippet Pin_outs_SUT.c usage_Pin_outs_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_outs_SUT.c usage_Pin_outs_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin_outs_SUT.c usage_Pin_outs_Read  
*******************************************************************************/
...
* preferred Pin_outs_Read() API because the 
* Pin_outs_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Pin_outs_SUT.c usage_Pin_outs_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Pin_outs_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Pin_outs_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Pin_outs_0_INTR       (First pin in the list)
    *  - Pin_outs_1_INTR       (Second pin in the list)
    *  - ...
    *  - Pin_outs_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Pin_outs_SUT.c usage_Pin_outs_SetInterruptMode
    *******************************************************************************/
    void Pin_outs_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Pin_outs_0_INTR) != 0u) 
		{ 
			 Pin_outs_0_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_outs_1_INTR) != 0u) 
		{ 
			 Pin_outs_1_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_outs_2_INTR) != 0u) 
		{ 
			 Pin_outs_2_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & Pin_outs_3_INTR) != 0u) 
		{ 
			 Pin_outs_3_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Pin_outs_SUT.c usage_Pin_outs_ClearInterrupt
    *******************************************************************************/
